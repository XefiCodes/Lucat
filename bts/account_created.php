<?php 
    ...
    if(isset($_POST['register_button'])){
        ...
        if(strlen($uname) > 100 || strlen($uname) < 2) {
            array_push($error_array,  "Your username must be between 2 and 100 characters<br>");
        }
        ...
        if(empty($error_array)) {
            ...
            $query = mysqli_query($con, "INSERT INTO users (username, email, password, prof_pic, cover_pic, bio, signup_date, user_closed, friend_array, comment_stat) VALUES ('$uname', '$em', '$password', '$prof_pic', '$cover_pic', '$bio', '$date', 'no', ',', '')");
